...
namespace XLua.CSObjectWrap
{
    ...
    public class ProjectYUIUIPointerStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ProjectY.UI.UIPointerState);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ProjectY.UI.UIPointerState();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ProjectY.UI.UIPointerState constructor!");
        ...
        static int _m_OnPointerEnter(RealStatePtr L)
        {
		    try {
                ...
                ProjectY.UI.UIPointerState gen_to_be_invoked = (ProjectY.UI.UIPointerState)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Hovered(RealStatePtr L)
        {
		    try {
                ...
                ProjectY.UI.UIPointerState gen_to_be_invoked = (ProjectY.UI.UIPointerState)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.Hovered);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
