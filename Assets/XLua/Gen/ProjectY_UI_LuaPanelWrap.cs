...
namespace XLua.CSObjectWrap
{
    ...
    public class ProjectYUILuaPanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ProjectY.UI.LuaPanel);
			Utils.BeginObjectRegister(type, L, translator, 0, 1, 4, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetWorldCamera", _m_SetWorldCamera);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ProjectY.UI.LuaPanel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ProjectY.UI.LuaPanel constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetWorldCamera(RealStatePtr L)
        {
		    try {
                ...
                ProjectY.UI.LuaPanel gen_to_be_invoked = (ProjectY.UI.LuaPanel)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetWorldCamera( _camera );
