...
kit=json.loads((root/'Art/TownInteriorLowPoly/Integration/kit-design.json').read_text(encoding='utf-8'))
directions=[(1,0),(0,1),(-1,1),(-1,0),(0,-1),(1,-1)]
report=[]
for row,item in zip(rows,kit):
...
path=root/'Art/TownInteriorLowPoly/Integration/geometry-check.json';path.write_text(json.dumps(report,indent=2),encoding='utf-8')
